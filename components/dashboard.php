        ...
        <div class="page-wrapper mt-5">
            <div class="container-fluid">
                ...
                if ($pageId == "products") {
                    ...
                    include "dashboard/book.php";
                } else if ($pageId == "viewbooking") {
                    include "dashboard/viewbooking.php";
            ...
            <footer class="footer text-center">All rights reserved &copy; <?= date("Y") ?>. Hospital information system</footer>
        </div>
    </div>
</body>
